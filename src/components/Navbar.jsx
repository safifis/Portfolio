      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-gray-900 to-gray-600 bg-gradient-to-r absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
